        ...
        <section class="bg-light-yellow py-70">
            <div class="container mb-70">
                <div class="d-flex align-items-center mb-5">
                    ...
                    <!--<button-arrows v-if="partners.length > 1" @onLeftClick="prev()" @onRightClick="next()" class="d-inline-block d-md-none ml-auto"></button-arrows>-->
                </div>
                <div class="row mb-5 pb-2" ref="logos" @afterChange="handleAfterChange">
                    <div class="col-3" v-for="partner in partners" v-bind:key="partner.id">
